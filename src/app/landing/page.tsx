            ...
            <div className="min-h-screen flex flex-col items-center py-[103px]">
              ...
              <span className="float-left text-[56px] font-[TamdanBold] leading-[0.8] mr-3 mt-1">
                T
                            ...
                            AMDAN is an intelligent, AI-powered search companion designed to keep
                            you informed and connected. Powered by advanced technologies like GPT-5
                            and n8n automation, TAMDAN goes beyond ordinary search — it gathers
                            real-time news, analyzes trusted sources, and delivers personalized
                    ...
                    <div className="mt-[44px]">
                        <p>
                            Whether it’s daily news, research insights, or topic-specific trends,
                            TAMDAN ensures you never miss what’s important — your intelligent
                            search partner, powered by AI.
                        </p>
                    </div>
                </div>
